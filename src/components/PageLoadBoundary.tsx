...
export const PageLoadingState: React.FC = () => (
  <div className="page-load-state" role="status" aria-live="polite" aria-busy="true">
...
export class PageLoadBoundary extends Component<PageLoadBoundaryProps, PageLoadBoundaryState> {
  ...
  render() {
    if (this.state.error) {
      ...
      return (
        <section
          className="page-load-state page-load-state--error"
          role="alert"
          aria-labelledby="page-load-error-title"
          aria-describedby="page-load-error-description"
        >
          <div className="page-load-state__content">
            <span className="page-load-state__marker" aria-hidden="true" />
            <h2 id="page-load-error-title">Page unavailable</h2>
            <p id="page-load-error-description">This page could not be loaded. Reload the application to try again.</p>
